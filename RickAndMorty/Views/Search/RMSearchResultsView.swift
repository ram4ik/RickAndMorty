...
//  RickAndMorty
//
//  Created by Ramill Ibragimov on 05.03.2023.
//

import UIKit

protocol RMSearchResultsViewDelegate: AnyObject {
    func rmRMSearchResultsView(_ resultsView: RMSearchResultsView, didTapLocationAt index: Int)
}
...
extension RMSearchResultsView: UITableViewDataSource, UITableViewDelegate {
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        delegate?.rmRMSearchResultsView(self, didTapLocationAt: indexPath.row)
    }
}
...
extension RMSearchResultsView: UICollectionViewDelegate, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout {
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        if let characterVM = currentViewModel as? RMCharacterListViewCollectionViewCellViewModel {
            guard let cell = collectionView.dequeueReusableCell(
                withReuseIdentifier: RMCharacterListViewCollectionViewCell.cellIdentifier,
                for: indexPath) as? RMCharacterListViewCollectionViewCell else {
                fatalError()
            }
    ...
    func collectionView(_ collectionView: UICollectionView, layout collectionViewLayout: UICollectionViewLayout, sizeForItemAt indexPath: IndexPath) -> CGSize {
        ...
        if currentViewModel is RMCharacterListViewCollectionViewCellViewModel {
